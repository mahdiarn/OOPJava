 ...
 */
public class HiuPutih extends Selachii{
    ...
    @Override
    public void Eat() {
        System.out.println("Porsi makanan hiu putih ini adalah " + weight*0.025 + " kg."); //To change body of generated methods, choose Tools | Templates.
    }
